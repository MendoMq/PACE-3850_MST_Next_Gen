...
async function initData() {
    ...
    let media = new Media({
        "title": "Hugo Weaving Supports Marian Street Theatre",
        "path": "https://www.youtube.com/embed/_G_2NX_cOyQ",
    })
    let media2 = new Media({
        "title": "David Williamson Supports Marian Street Theatre",
        "path": "https://www.youtube.com/embed/0v146jfbwdg",
    })
    await media.save()
    await media2.save()
